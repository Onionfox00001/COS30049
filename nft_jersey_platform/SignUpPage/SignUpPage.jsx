  ...
  return (
    <div className={Style.SignUp}>
        <div className={Style.SignUp_box}>
            <h2 className={Style.SignUp_box_title}>Sign Up</h2>
            <form>
                <div className={Style.SignUp_box_input}>
                    <label htmlFor="name">Username</label>
                    <input type="text" placeholder="Enter your username" className={Style.SignUp_box_input_name}/>
                </div>

                <div className={Style.SignUp_box_input}>
                    <label htmlFor="password">Password</label>
                    <input type="text" placeholder="Enter your password" className={Style.SignUp_box_input_password}/>
                </div>

                <div className={Style.SignUp_box_input}>
                    <label htmlFor="email">Email</label>
                    <input type="text" placeholder="Enter your email" className={Style.SignUp_box_input_email}/>
                </div>


                <div className={Style.SignUp_box_button}>
                    {/* <Button 
                        btnName= "Sign in"
                        handleClick={() => {}}
                        classStyle = {Style.button}
                    /> */}
                    <button className={Style.SignUp_box_button_signup}>Sign Up</button>
                </div>

                <div className={Style.SignUp_box_social_message}>
                    <div className={Style.SignUp_box_social_message_line}></div>
                    <p className={Style.SignUp_box_social_message_msg}>Sign up with social accounts</p>
                    <div className={Style.SignUp_box_social_message_line}></div>
                </div>

                <div className={Style.SignUp_box_social_icons}>
                ...
                <div className={Style.SignUp_box_link}>
                    <p>
